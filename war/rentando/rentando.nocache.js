...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "rentando" because\n';
  ...
  $wnd.__gwt_activeModules['rentando'] = {
    'moduleName' : 'rentando',
    'bindings' : function() {
      return {};
    }
 ...
 * "/rentando.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['rentando'].superdevmode = true;

  var expectedSuffix = '/rentando.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + rentando + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:rentando';
  var devModeSessionKey = '__gwtDevModeSession:rentando';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/rentando/rentando.nocache.js';
  ...
  $wnd.__gwt_activeModules['rentando'].canRedirect = true;
  $wnd.__gwt_activeModules['rentando'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/rentando?user.agent=' + ua + '&_callback=' + callback;
